          ...
          <div className="flex mt-11">
            <div className="ml-2 mt-6 text-center w-3/5">
              <AnimatedText>
                ...
                global audience of collectors and enthusiasts. Whether you are
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
                  ...
                  <img src="/logoHere2.png " className="h-52 w-80  " alt="FlowBite Logo" />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/Prakhar-30/Mercado" className="hover:underline ">Github</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Mercado™</a>. All Rights Reserved.
          </span>
